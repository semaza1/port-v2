...
export default function App() {
  ...
  return (
    <>
      {/* Global custom cursor — sits outside layout flow */}
      <CustomCursor />
            ...
            <Route path="*" element={
              <PageWrapper>
                <div className="min-h-[70vh] flex flex-col items-center justify-center gap-4 text-center px-6">
                  ...
                  <a href="/" className="mt-2 text-sm text-accent hover:text-accent-hover underline underline-offset-4 transition-colors">
                    Back to home
                  </a>
                </div>
              </PageWrapper>
